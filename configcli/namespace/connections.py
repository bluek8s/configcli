...
class NamespaceConnections(ConfigCLI_SubCommand):
    ...
    def __init__(self, cmdObj):
        ConfigCLI_SubCommand.__init__(self, cmdObj, 'connections')

    def getSubcmdDescripton(self):
        return 'The connections namespace from the application configuration metadata.'
...
ConfigCLI_SubCommand.register(NamespaceConnections)
__all__ = ['NamespaceConnections']
